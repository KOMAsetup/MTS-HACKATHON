...
async def run_repair_loop(
    ...
    *,
    ...
    for i in range(max_repair_attempts):
        ...
        log_check_outcome(outcome="fail", violations=result.violations, repair_attempt=repair_rounds_used)
...
async def run_generate_pipeline(
    ...
    user_msg = build_generate_user_message(body.prompt, body.clarification_history)
...
async def run_refine_pipeline(
    ...
    user_msg = build_refinement_user_message(body.prompt, body.refinement_history)
